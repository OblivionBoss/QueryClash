...
public class SinglePlacementState : IBuildingState
{
    ...
    public SinglePlacementState(int iD,
                          Grid grid,
                          SinglePreviewSystem previewSystem,
                          ObjectsDatabaseSO database,
                          SingleGridData floorData,
    ...
    public void OnAction(Vector3Int gridPosition)
    {
        ...
        SingleGridData selectedData = database.objectsData[selectedObjectIndex].ID == 0 ?
            floorData :
            unitData;
    ...
    private bool CheckPlacementValidity(Vector3Int gridPosition, int selectedObjectIndex)
    {
        ...
        SingleGridData selectedData = selectedObjectData.ID == 0 ? floorData : unitData;
